    ...
    <GuestLayout>
        ...
        <div class="container">
            <ul role="list" class="divide-y divide-gray-100">
                <li v-for="person in people" :key="person.email" class="flex justify-between items-center gap-x-6 py-5">
                    ...
                    <div class="hidden shrink-0 sm:flex sm:flex-col sm:items-center">
                        <div class="buttons">
                            ...
                            <button class="btn danger" @click="confirmUserDeletion">Удалить</button>
                        </div>
                    </div>
                </li>
            </ul>
